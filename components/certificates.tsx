    ...
    <div className="p-6 space-y-6">
        ...
        <Card className="bg-card border-border">
          ...
          <CardContent>
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-card-foreground">{mockCertificates.length}</span>
            </div>
          ...
          <CardContent>
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-card-foreground">
                {mockCertificates.filter((c) => c.date.startsWith("2024-01")).length}
              </span>
            </div>
      ...
      <Card className="bg-card border-border">
        <CardHeader>
          ...
          <CardDescription>
            {filteredCertificates.length} of {mockCertificates.length} certificates
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          {selectedCertificate && (
            <div className="space-y-6">
              <div className="text-center p-6 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-lg border">
                <div className="text-2xl font-bold text-primary mb-2">🛡️ SecureWipe Pro</div>
